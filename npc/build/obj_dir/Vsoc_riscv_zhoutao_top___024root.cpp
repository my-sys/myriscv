...
VL_INLINE_OPT void Vsoc_riscv_zhoutao_top___024root___sequent__TOP__2(Vsoc_riscv_zhoutao_top___024root* vlSelf) {
    ...
    // Body
    vlSelf->soc_riscv_zhoutao_top__DOT__FSM_bin_1__DOT__state_dout 
        = ((IData)(vlSelf->reset) ? 0U : (IData)(vlSelf->soc_riscv_zhoutao_top__DOT__FSM_bin_1__DOT__state_din));
...
VL_INLINE_OPT void Vsoc_riscv_zhoutao_top___024root___combo__TOP__3(Vsoc_riscv_zhoutao_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsoc_riscv_zhoutao_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsoc_riscv_zhoutao_top___024root___combo__TOP__3\n"); );
    // Variables
...
void Vsoc_riscv_zhoutao_top___024root___eval(Vsoc_riscv_zhoutao_top___024root* vlSelf) {
    ...
    Vsoc_riscv_zhoutao_top___024root___combo__TOP__3(vlSelf);
