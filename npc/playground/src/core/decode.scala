...
class Decode extends Module{
	...
	val decodefault	= List(Op_type.op_n,ALUType.alu_addi,Inst_type.Type_N,false.B,false.B,false.B)
	...
	val opType :: exuType :: instType :: dest_is_reg :: rs1_is_reg ::Nil = ListLookup(inst,decodefault,ISA.table)
