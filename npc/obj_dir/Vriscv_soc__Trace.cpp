...
void Vriscv_soc___024root__traceChgSub0(Vriscv_soc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+242,(vlSelf->riscv_soc__DOT__core__DOT__decode__DOT__opType),2);
            tracep->chgCData(oldp+243,(vlSelf->riscv_soc__DOT__core__DOT__decode__DOT__instType),4);
            tracep->chgCData(oldp+244,((0x1fU & (vlSelf->riscv_soc__DOT__core__DOT__fetch__DOT__regInst 
                                                 >> 7U))),5);
            tracep->chgSData(oldp+245,((vlSelf->riscv_soc__DOT__core__DOT__fetch__DOT__regInst 
                                        >> 0x14U)),12);
            tracep->chgQData(oldp+246,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__mem_data),64);
            tracep->chgQData(oldp+248,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__mem_wstrb),64);
            tracep->chgBit(oldp+250,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__reg_ls_state));
            tracep->chgIData(oldp+251,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__reg_inst),32);
            tracep->chgQData(oldp+252,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__reg_pc),64);
        }
        tracep->chgBit(oldp+254,(vlSelf->clock));
        tracep->chgBit(oldp+255,(vlSelf->reset));
        tracep->chgQData(oldp+256,(vlSelf->io_difftest_reg_0),64);
        tracep->chgQData(oldp+258,(vlSelf->io_difftest_reg_1),64);
        tracep->chgQData(oldp+260,(vlSelf->io_difftest_reg_2),64);
        tracep->chgQData(oldp+262,(vlSelf->io_difftest_reg_3),64);
        tracep->chgQData(oldp+264,(vlSelf->io_difftest_reg_4),64);
        tracep->chgQData(oldp+266,(vlSelf->io_difftest_reg_5),64);
        tracep->chgQData(oldp+268,(vlSelf->io_difftest_reg_6),64);
        tracep->chgQData(oldp+270,(vlSelf->io_difftest_reg_7),64);
        tracep->chgQData(oldp+272,(vlSelf->io_difftest_reg_8),64);
        tracep->chgQData(oldp+274,(vlSelf->io_difftest_reg_9),64);
        tracep->chgQData(oldp+276,(vlSelf->io_difftest_reg_10),64);
        tracep->chgQData(oldp+278,(vlSelf->io_difftest_reg_11),64);
        tracep->chgQData(oldp+280,(vlSelf->io_difftest_reg_12),64);
        tracep->chgQData(oldp+282,(vlSelf->io_difftest_reg_13),64);
        tracep->chgQData(oldp+284,(vlSelf->io_difftest_reg_14),64);
        tracep->chgQData(oldp+286,(vlSelf->io_difftest_reg_15),64);
        tracep->chgQData(oldp+288,(vlSelf->io_difftest_reg_16),64);
        tracep->chgQData(oldp+290,(vlSelf->io_difftest_reg_17),64);
        tracep->chgQData(oldp+292,(vlSelf->io_difftest_reg_18),64);
        tracep->chgQData(oldp+294,(vlSelf->io_difftest_reg_19),64);
        tracep->chgQData(oldp+296,(vlSelf->io_difftest_reg_20),64);
        tracep->chgQData(oldp+298,(vlSelf->io_difftest_reg_21),64);
        tracep->chgQData(oldp+300,(vlSelf->io_difftest_reg_22),64);
        tracep->chgQData(oldp+302,(vlSelf->io_difftest_reg_23),64);
        tracep->chgQData(oldp+304,(vlSelf->io_difftest_reg_24),64);
        tracep->chgQData(oldp+306,(vlSelf->io_difftest_reg_25),64);
        tracep->chgQData(oldp+308,(vlSelf->io_difftest_reg_26),64);
        tracep->chgQData(oldp+310,(vlSelf->io_difftest_reg_27),64);
        tracep->chgQData(oldp+312,(vlSelf->io_difftest_reg_28),64);
        tracep->chgQData(oldp+314,(vlSelf->io_difftest_reg_29),64);
        tracep->chgQData(oldp+316,(vlSelf->io_difftest_reg_30),64);
        tracep->chgQData(oldp+318,(vlSelf->io_difftest_reg_31),64);
        tracep->chgQData(oldp+320,(vlSelf->io_difftest_pc),64);
        tracep->chgIData(oldp+322,(vlSelf->io_difftest_inst),32);
        tracep->chgBit(oldp+323,(vlSelf->io_difftest_commit));
    }
}
