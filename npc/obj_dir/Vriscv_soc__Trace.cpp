...
void Vriscv_soc___024root__traceChgSub0(Vriscv_soc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgWData(oldp+579,(__Vtemp4303),65);
            ...
            tracep->chgWData(oldp+585,(vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__mu_exu__DOT__mul__DOT__mul_data1),65);
            ...
            tracep->chgWData(oldp+599,(vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__mu_exu__DOT__mul__DOT__reg_mul1),130);
            ...
            tracep->chgWData(oldp+610,(vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__mu_exu__DOT__mul__DOT__pp),131);
            ...
            tracep->chgCData(oldp+681,((0x1fU & (vlSelf->riscv_soc__DOT__core__DOT__fetch__DOT__reg_inst 
                                                 >> 0xfU))),5);
            tracep->chgQData(oldp+682,(vlSelf->riscv_soc__DOT__core__DOT__decode__DOT__regfile_rs1_data_MPORT_data),64);
            tracep->chgCData(oldp+684,((0x1fU & (vlSelf->riscv_soc__DOT__core__DOT__fetch__DOT__reg_inst 
                                                 >> 0x14U))),5);
            tracep->chgQData(oldp+685,(vlSelf->riscv_soc__DOT__core__DOT__decode__DOT__regfile_rs2_data_MPORT_data),64);
            ...
            tracep->chgCData(oldp+694,((0x1fU & (vlSelf->riscv_soc__DOT__core__DOT__fetch__DOT__reg_inst 
                                                 >> 7U))),5);
            tracep->chgSData(oldp+695,((vlSelf->riscv_soc__DOT__core__DOT__fetch__DOT__reg_inst 
                                        >> 0x14U)),12);
            tracep->chgBit(oldp+696,(vlSelf->riscv_soc__DOT__core__DOT__decode__DOT__temp_stall));
            ...
            tracep->chgQData(oldp+704,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__mem_data_result),64);
            tracep->chgQData(oldp+706,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__mem_wstrb),64);
            tracep->chgBit(oldp+708,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__reg_ls_state));
            tracep->chgQData(oldp+709,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__rs2_data),64);
            tracep->chgWData(oldp+711,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__mem_w_data),127);
            tracep->chgIData(oldp+715,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__reg_inst),32);
            tracep->chgQData(oldp+716,(vlSelf->riscv_soc__DOT__core__DOT__write_back__DOT__reg_pc),64);
            tracep->chgQData(oldp+718,(vlSelf->riscv_soc__DOT__axi_ram__DOT__mem_raddr),64);
            tracep->chgQData(oldp+720,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_w_addr),64);
            tracep->chgQData(oldp+722,(vlSelf->riscv_soc__DOT__axi_ram__DOT__mem_wmask),64);
            tracep->chgBit(oldp+724,(vlSelf->riscv_soc__DOT__axi_ram__DOT__mem_wen));
            tracep->chgQData(oldp+725,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_raddr),64);
            tracep->chgCData(oldp+727,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_rlen),4);
            tracep->chgBit(oldp+728,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_r_state));
            tracep->chgBit(oldp+729,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_is_w));
            tracep->chgIData(oldp+730,(vlSelf->riscv_soc__DOT__axi_ram__DOT__mem_io_wmask_lo),32);
            tracep->chgIData(oldp+731,(vlSelf->riscv_soc__DOT__axi_ram__DOT__mem_io_wmask_hi),32);
        }
        tracep->chgBit(oldp+732,(vlSelf->clock));
        tracep->chgBit(oldp+733,(vlSelf->reset));
        tracep->chgQData(oldp+734,(vlSelf->io_difftest_reg_0),64);
        tracep->chgQData(oldp+736,(vlSelf->io_difftest_reg_1),64);
        tracep->chgQData(oldp+738,(vlSelf->io_difftest_reg_2),64);
        tracep->chgQData(oldp+740,(vlSelf->io_difftest_reg_3),64);
        tracep->chgQData(oldp+742,(vlSelf->io_difftest_reg_4),64);
        tracep->chgQData(oldp+744,(vlSelf->io_difftest_reg_5),64);
        tracep->chgQData(oldp+746,(vlSelf->io_difftest_reg_6),64);
        tracep->chgQData(oldp+748,(vlSelf->io_difftest_reg_7),64);
        tracep->chgQData(oldp+750,(vlSelf->io_difftest_reg_8),64);
        tracep->chgQData(oldp+752,(vlSelf->io_difftest_reg_9),64);
        tracep->chgQData(oldp+754,(vlSelf->io_difftest_reg_10),64);
        tracep->chgQData(oldp+756,(vlSelf->io_difftest_reg_11),64);
        tracep->chgQData(oldp+758,(vlSelf->io_difftest_reg_12),64);
        tracep->chgQData(oldp+760,(vlSelf->io_difftest_reg_13),64);
        tracep->chgQData(oldp+762,(vlSelf->io_difftest_reg_14),64);
        tracep->chgQData(oldp+764,(vlSelf->io_difftest_reg_15),64);
        tracep->chgQData(oldp+766,(vlSelf->io_difftest_reg_16),64);
        tracep->chgQData(oldp+768,(vlSelf->io_difftest_reg_17),64);
        tracep->chgQData(oldp+770,(vlSelf->io_difftest_reg_18),64);
        tracep->chgQData(oldp+772,(vlSelf->io_difftest_reg_19),64);
        tracep->chgQData(oldp+774,(vlSelf->io_difftest_reg_20),64);
        tracep->chgQData(oldp+776,(vlSelf->io_difftest_reg_21),64);
        tracep->chgQData(oldp+778,(vlSelf->io_difftest_reg_22),64);
        tracep->chgQData(oldp+780,(vlSelf->io_difftest_reg_23),64);
        tracep->chgQData(oldp+782,(vlSelf->io_difftest_reg_24),64);
        tracep->chgQData(oldp+784,(vlSelf->io_difftest_reg_25),64);
        tracep->chgQData(oldp+786,(vlSelf->io_difftest_reg_26),64);
        tracep->chgQData(oldp+788,(vlSelf->io_difftest_reg_27),64);
        tracep->chgQData(oldp+790,(vlSelf->io_difftest_reg_28),64);
        tracep->chgQData(oldp+792,(vlSelf->io_difftest_reg_29),64);
        tracep->chgQData(oldp+794,(vlSelf->io_difftest_reg_30),64);
        tracep->chgQData(oldp+796,(vlSelf->io_difftest_reg_31),64);
        tracep->chgQData(oldp+798,(vlSelf->io_difftest_pc),64);
        tracep->chgIData(oldp+800,(vlSelf->io_difftest_inst),32);
        tracep->chgBit(oldp+801,(vlSelf->io_difftest_commit));
        tracep->chgQData(oldp+802,(vlSelf->io_inst_counter),64);
    }
}
