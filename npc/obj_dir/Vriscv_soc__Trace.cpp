...
void Vriscv_soc___024root__traceChgSub0(Vriscv_soc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            __Vtemp4272[0U] = (~ vlSelf->riscv_soc__DOT__core__DOT__i_cache__DOT__cache_mask[0U]);
            __Vtemp4272[1U] = (~ vlSelf->riscv_soc__DOT__core__DOT__i_cache__DOT__cache_mask[1U]);
            __Vtemp4272[2U] = (~ vlSelf->riscv_soc__DOT__core__DOT__i_cache__DOT__cache_mask[2U]);
            __Vtemp4272[3U] = (~ vlSelf->riscv_soc__DOT__core__DOT__i_cache__DOT__cache_mask[3U]);
            tracep->chgWData(oldp+190,(__Vtemp4272),128);
            ...
            VL_EXTEND_WQ(128,56, __Vtemp4273, vlSelf->riscv_soc__DOT__core__DOT__i_cache__DOT___sram1_tag_io_D_T_1);
            tracep->chgWData(oldp+205,(__Vtemp4273),128);
            ...
            __Vtemp4274[0U] = (~ vlSelf->riscv_soc__DOT__core__DOT__d_cache__DOT__cache_mask[0U]);
            __Vtemp4274[1U] = (~ vlSelf->riscv_soc__DOT__core__DOT__d_cache__DOT__cache_mask[1U]);
            __Vtemp4274[2U] = (~ vlSelf->riscv_soc__DOT__core__DOT__d_cache__DOT__cache_mask[2U]);
            __Vtemp4274[3U] = (~ vlSelf->riscv_soc__DOT__core__DOT__d_cache__DOT__cache_mask[3U]);
            tracep->chgWData(oldp+339,(__Vtemp4274),128);
            ...
            VL_EXTEND_WQ(128,56, __Vtemp4275, vlSelf->riscv_soc__DOT__core__DOT__d_cache__DOT___sram1_tag_io_D_T_1);
            tracep->chgWData(oldp+354,(__Vtemp4275),128);
            ...
            __Vtemp4279[0U] = __Vtemp4278[0U];
            __Vtemp4279[1U] = __Vtemp4278[1U];
            __Vtemp4279[2U] = (1U & __Vtemp4278[2U]);
            tracep->chgWData(oldp+541,(__Vtemp4279),65);
            __Vtemp4281[0U] = 1U;
            __Vtemp4281[1U] = 0U;
            __Vtemp4281[2U] = 0U;
            VL_ADD_W(3, __Vtemp4282, __Vtemp4281, vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__alu_exu__DOT___subresult_T_2);
            ...
            __Vtemp4284[0U] = (IData)((0xfffffffffffffffeULL 
                                       & vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__alu_exu__DOT___next_pc3_T_1));
            __Vtemp4284[1U] = (IData)(((0xfffffffffffffffeULL 
                                        & vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__alu_exu__DOT___next_pc3_T_1) 
                                       >> 0x20U));
            __Vtemp4284[2U] = 1U;
            tracep->chgWData(oldp+554,(__Vtemp4284),65);
            ...
            __Vtemp4286[1U] = 0U;
            __Vtemp4286[2U] = 0U;
            __Vtemp4287[0U] = (~ vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__mu_exu__DOT__div__DOT__reg_divisor[0U]);
            __Vtemp4287[1U] = (~ vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__mu_exu__DOT__div__DOT__reg_divisor[1U]);
            __Vtemp4287[2U] = (~ vlSelf->riscv_soc__DOT__core__DOT__execute__DOT__mu_exu__DOT__div__DOT__reg_divisor[2U]);
            VL_ADD_W(3, __Vtemp4288, __Vtemp4286, __Vtemp4287);
            __Vtemp4289[0U] = __Vtemp4288[0U];
            __Vtemp4289[1U] = __Vtemp4288[1U];
            __Vtemp4289[2U] = (1U & __Vtemp4288[2U]);
            tracep->chgWData(oldp+588,(__Vtemp4289),65);
            ...
            tracep->chgQData(oldp+711,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_ar_araddr),64);
            tracep->chgQData(oldp+713,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_aw_awaddr),64);
            tracep->chgQData(oldp+715,(vlSelf->riscv_soc__DOT__axi_ram__DOT__mem_wmask),64);
            tracep->chgBit(oldp+717,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_is_w));
            tracep->chgCData(oldp+718,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_ar_arlen),8);
            tracep->chgBit(oldp+719,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_start_read));
            tracep->chgBit(oldp+720,(vlSelf->riscv_soc__DOT__axi_ram__DOT__reg_r_state));
            tracep->chgIData(oldp+721,(vlSelf->riscv_soc__DOT__axi_ram__DOT__mem_io_wmask_lo),32);
            tracep->chgIData(oldp+722,(vlSelf->riscv_soc__DOT__axi_ram__DOT__mem_io_wmask_hi),32);
        }
        tracep->chgBit(oldp+723,(vlSelf->clock));
        tracep->chgBit(oldp+724,(vlSelf->reset));
        tracep->chgQData(oldp+725,(vlSelf->io_difftest_reg_0),64);
        tracep->chgQData(oldp+727,(vlSelf->io_difftest_reg_1),64);
        tracep->chgQData(oldp+729,(vlSelf->io_difftest_reg_2),64);
        tracep->chgQData(oldp+731,(vlSelf->io_difftest_reg_3),64);
        tracep->chgQData(oldp+733,(vlSelf->io_difftest_reg_4),64);
        tracep->chgQData(oldp+735,(vlSelf->io_difftest_reg_5),64);
        tracep->chgQData(oldp+737,(vlSelf->io_difftest_reg_6),64);
        tracep->chgQData(oldp+739,(vlSelf->io_difftest_reg_7),64);
        tracep->chgQData(oldp+741,(vlSelf->io_difftest_reg_8),64);
        tracep->chgQData(oldp+743,(vlSelf->io_difftest_reg_9),64);
        tracep->chgQData(oldp+745,(vlSelf->io_difftest_reg_10),64);
        tracep->chgQData(oldp+747,(vlSelf->io_difftest_reg_11),64);
        tracep->chgQData(oldp+749,(vlSelf->io_difftest_reg_12),64);
        tracep->chgQData(oldp+751,(vlSelf->io_difftest_reg_13),64);
        tracep->chgQData(oldp+753,(vlSelf->io_difftest_reg_14),64);
        tracep->chgQData(oldp+755,(vlSelf->io_difftest_reg_15),64);
        tracep->chgQData(oldp+757,(vlSelf->io_difftest_reg_16),64);
        tracep->chgQData(oldp+759,(vlSelf->io_difftest_reg_17),64);
        tracep->chgQData(oldp+761,(vlSelf->io_difftest_reg_18),64);
        tracep->chgQData(oldp+763,(vlSelf->io_difftest_reg_19),64);
        tracep->chgQData(oldp+765,(vlSelf->io_difftest_reg_20),64);
        tracep->chgQData(oldp+767,(vlSelf->io_difftest_reg_21),64);
        tracep->chgQData(oldp+769,(vlSelf->io_difftest_reg_22),64);
        tracep->chgQData(oldp+771,(vlSelf->io_difftest_reg_23),64);
        tracep->chgQData(oldp+773,(vlSelf->io_difftest_reg_24),64);
        tracep->chgQData(oldp+775,(vlSelf->io_difftest_reg_25),64);
        tracep->chgQData(oldp+777,(vlSelf->io_difftest_reg_26),64);
        tracep->chgQData(oldp+779,(vlSelf->io_difftest_reg_27),64);
        tracep->chgQData(oldp+781,(vlSelf->io_difftest_reg_28),64);
        tracep->chgQData(oldp+783,(vlSelf->io_difftest_reg_29),64);
        tracep->chgQData(oldp+785,(vlSelf->io_difftest_reg_30),64);
        tracep->chgQData(oldp+787,(vlSelf->io_difftest_reg_31),64);
        tracep->chgQData(oldp+789,(vlSelf->io_difftest_pc),64);
        tracep->chgIData(oldp+791,(vlSelf->io_difftest_inst),32);
        tracep->chgBit(oldp+792,(vlSelf->io_difftest_commit));
    }
}
