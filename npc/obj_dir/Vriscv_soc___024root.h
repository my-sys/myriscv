...
VL_MODULE(Vriscv_soc___024root) {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ riscv_soc__DOT__core__DOT__fetch__DOT__br_predictor__DOT__PHT_update_pht_data_data;
    ...
    struct {
        ...
        IData/*31:0*/ riscv_soc__DOT__core__DOT__fetch__DOT__ibuf__DOT__ibuf_inst_ibuf_inst_read_data;
        ...
        VlWide<4>/*127:0*/ riscv_soc__DOT__sram4__DOT__sram_temp_data_data;
        VlWide<4>/*127:0*/ riscv_soc__DOT__sram4__DOT__Q;
        VlWide<4>/*127:0*/ riscv_soc__DOT__sram5__DOT__Q;
        VlWide<4>/*127:0*/ riscv_soc__DOT__sram6__DOT__sram_temp_data_data;
