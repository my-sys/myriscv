...
VL_MODULE(Vriscv_soc___024root) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ riscv_soc__DOT__core__DOT__fetch__DOT___ibuf_io_cache_buf_valid_T_3;
        ...
        CData/*2:0*/ riscv_soc__DOT__core__DOT__fetch__DOT__ibuf__DOT__reg_full_size;
