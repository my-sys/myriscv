...
void Vsoc_riscv_zhoutao_top___024root__traceInitSub0(Vsoc_riscv_zhoutao_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+3,"soc_riscv_zhoutao_top f", false,-1);
        tracep->declBit(c+1,"soc_riscv_zhoutao_top top1 a", false,-1);
        tracep->declBit(c+2,"soc_riscv_zhoutao_top top1 b", false,-1);
        tracep->declBit(c+3,"soc_riscv_zhoutao_top top1 f", false,-1);
    }
}
