...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 000 ????? 01110 01", addw   , R, R(dest) = SEXT(BITS(src1,31,0)+ BITS(src2,31,0),32));
  ...
  INSTPAT("??????? ????? ????? 111 ????? 11100 11", csrrci , CSR, R(dest) = csr_value; CSR_R(csr_addr) = csr_value & (~src2));
