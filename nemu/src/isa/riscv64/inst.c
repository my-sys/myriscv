...
static word_t immB(uint32_t i) { return SEXT(BITS(i,31,31)<<11 | BITS(i,30,25)<<4 | BITS(i,11,8) | BITS(i,10,10)<<10,12)<<1; }
...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 00000 00000 000 00000 01100 11", add    , R, R(dest) = src1 + src2);
