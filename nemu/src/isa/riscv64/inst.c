...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli   , IR, R(dest) = src1 << src2);
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 01110 11", divuw  , R, uint32_t temp1 = src1; uint32_t temp2 = src2; SEXT((temp1/temp2),32));
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, int32_t temp1 = src1;int32_t temp2 = src2; SEXT((temp1/temp2),32));
